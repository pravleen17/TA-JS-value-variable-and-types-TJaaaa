...
- `if` the age is greater than 55 then print the message " c".
👇
*/
...
if (product > 0) {
    ...
    alert(`The final value is negetive`);
}
...
let operation = prompt("Enter an operation out of (Add, Sub, Multiply, Divide");
